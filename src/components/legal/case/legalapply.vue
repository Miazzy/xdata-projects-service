            ...
            <div style="background-color:#f0f0f0;">
              ...
              <div id="legal-apply-content" class="reward-apply-content" style="height:auto; background-color:#fefefe; margin-top:0px; margin-left: 1.25rem; margin-right: 1.25rem; margin-bottom: 5rem; border: 1px solid #f0f0f0; front-size: 1rem;" >
                ...
                <div v-if=" (role == 'view' || role == 'delete') && legal.close_flag != '是' " style="position:absolute; width:1000px; left: 1.75rem; float:left; height:30px; transform:scale(0.625); transform-origin: left center;  margin-right:0.025rem;" >
                  ...
                  <a-tag color="#c05890" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center; display:none;" @click="execPrint(legal)"> 打印 </a-tag>
                  ...
                  <a-tag color="#d08710" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execPaperApply(legal)"> 发起文书盖章 </a-tag>
                ...
                <div v-if=" (role == 'operate') && legal.close_flag != '是' " style="position:absolute; width:1000px; left: -4.25rem; float:left; height:30px; transform:scale(0.625); transform-origin: left center;  margin-right:0.025rem;">
                  <a-tag color="#3a3990" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execStageDone('endJudge', '归档闭单')"> 归档闭单(结案) </a-tag>
                  <a-tag color="#59a890" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execStageDone('execJudge', '执行阶段')"> 进入执行阶段 </a-tag>
                  <a-tag color="#a93e80" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execStageDone('revJudge', '再审阶段')"> 进入再审阶段 </a-tag>
                  <a-tag color="#8a39f0" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execStageDone('secJudge', '二审阶段')"> 进入二审阶段 </a-tag>
                  <a-tag color="#993990" style="position: relative; float:right; right:7.5rem; margin-top:0.75rem; margin-left:0.25rem; transform-origin: left center;" @click="execStageDone('fstJudge', '一审阶段')"> 进入一审阶段 </a-tag>
                ...
                <div v-if="role != 'process' && role != 'operate'" class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px; display:none;">
                  <a-row>
                    <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                ...
                <div v-if="!(role == 'add' && (legal.stage == '' || legal.stage == '一审阶段' || legal.stage == '二审阶段' || legal.stage == '再审阶段' || legal.stage == '执行阶段' || legal.stage == '劳动仲裁' || legal.stage == '行政复议' )  && (legal.caseSType == '起诉案件' || legal.caseSType == '应诉案件'))" class="reward-apply-content-item reward-apply-content-title" style="padding-top:5px;padding-left:70px;" >
                      <a-tabs default-active-key="0" @change="callback">
                        ...
                        <a-tab-pane v-if="(stage != 'evaluate' && role != 'process' && role != 'operate') || operate == 'arbJudge' " key="0" tab="仲裁管理" style="margin-left:-35px;">
                          ...
                          <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                            <a-row>
                              ...
                              <a-col :span="8">
                                <a-auto-complete :data-source="lawyerInNamelist" v-model="legal.arbEmployee" @blur="validFieldToast('arbEmployee')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0; width:100%; border-width: 0px 0px 1px; border-style: solid; border-color: rgb(254, 254, 254) rgb(254, 254, 254) rgb(240, 240, 240); border-image: initial;"  placeholder="请输入内部律师！" :filter-option="filterOption" />
                              </a-col>
                              <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                                <span style="position:relative;" ><span style="color:red;margin-right:0px;position:absolute;left:-10px;top:0px;"></span>律师联系电话</span>
                              </a-col>
                              <a-col :span="8">
                                <a-input v-model="legal.arbEmployeeMobile"  placeholder="请输入内部律师联系电话！" @blur="validFieldToast('arbEmployeeMobile')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;" />
                              </a-col>
                            </a-row>
                          </div>    
                          ...
                          <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                            <a-row>
                              ...
                              <a-col :span="8">
                                <a-input v-model="legal.arbPlan" placeholder="请输入诉讼预案" @blur="validFieldToast('zone')"  style="width:100%; border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;"  />
                              </a-col>
                              <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                                <span style="position:relative;" ><span style="color:red;margin-right:0px;position:absolute;left:-10px;top:0px;"></span>未填写原因</span>
                              </a-col>
                              <a-col :span="8">
                                <a-input v-model="legal.arbReason" placeholder="请输入未填写原因！" @blur="validFieldToast('zoneProject')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;"  />
                              </a-col>
                            </a-row>
                          </div>
                        ...
                        <a-tab-pane v-if="(stage != 'evaluate' && role != 'process' && role != 'operate') || operate == 'fstJudge'  " key="1" tab="一审管理" style="margin-left:0px;">
                          ...
                          <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                            <a-row>
                              ...
                              <a-col :span="8">
                                <a-auto-complete :data-source="lawyerInNamelist" v-model="legal.fstEmployee" @blur="validFieldToast('inHouseLawyers')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0; width:100%; border-width: 0px 0px 1px; border-style: solid; border-color: rgb(254, 254, 254) rgb(254, 254, 254) rgb(240, 240, 240); border-image: initial;"  placeholder="请输入内部律师！" :filter-option="filterOption" />
                              </a-col>
                              <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                                <span style="position:relative;" ><span style="color:red;margin-right:0px;position:absolute;left:-10px;top:0px;"></span>律师联系电话</span>
                              </a-col>
                              <a-col :span="8">
                                <a-input v-model="legal.fstEmployeeMobile"  placeholder="请输入内部律师联系电话！" @blur="validFieldToast('inHouseLawyersMobile')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;" />
                              </a-col>
                            </a-row>
                          </div>    
                        ...
                        <a-tab-pane v-if="(stage != 'evaluate' && role != 'process' && role != 'operate' && '|二审阶段|再审阶段|执行阶段|归档闭单|'.includes(legal.stage) ) || operate == 'secJudge'  " key="2" tab="二审管理" style="margin-left:0px;">
                          ...
                          <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                            <a-row>
                              ...
                              <a-col :span="8">
                                <a-auto-complete :data-source="lawyerInNamelist" v-model="legal.secEmployee" @blur="validFieldToast('inHouseLawyers')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0; width:100%; border-width: 0px 0px 1px; border-style: solid; border-color: rgb(254, 254, 254) rgb(254, 254, 254) rgb(240, 240, 240); border-image: initial;"  placeholder="请输入内部律师！" :filter-option="filterOption" />
                              </a-col>
                              <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                                <span style="position:relative;" ><span style="color:red;margin-right:0px;position:absolute;left:-10px;top:0px;"></span>律师联系电话</span>
                              </a-col>
                              <a-col :span="8">
                                <a-input v-model="legal.secEmployeeMobile"  placeholder="请输入内部律师联系电话！" @blur="validFieldToast('inHouseLawyersMobile')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;" />
                              </a-col>
                            </a-row>
                          </div> 
                          </div>  

                          <div v-show=" '|二审阶段|再审阶段|执行阶段|归档闭单|'.includes(legal.stage) " class="reward-apply-content-item reward-apply-content-title" style="padding-top:5px;">
                            <a-row style="border-top: 1px dash #f0f0f0;" >
                              <a-col class="reward-apply-content-title-text" :span="4" style="font-size:1.1rem;">
                                诉讼信息
                              </a-col>
                        ...
                        <a-tab-pane v-if="(stage != 'evaluate' && role != 'process' && role != 'operate' && '|再审阶段|执行阶段|归档闭单|'.includes(legal.stage) ) || operate == 'revJudge'  " key="3" tab="再审管理" style="margin-left:0px;" >
                          ...
                          <div class="reward-apply-content-item" style="margin-top:5px;margin-bottom:5px; margin-right:10px;">
                            <a-row>
                              ...
                              <a-col :span="8">
                                <a-auto-complete :data-source="lawyerInNamelist" v-model="legal.revEmployee" @blur="validFieldToast('revEmployee')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0; width:100%; border-width: 0px 0px 1px; border-style: solid; border-color: rgb(254, 254, 254) rgb(254, 254, 254) rgb(240, 240, 240); border-image: initial;"  placeholder="请输入内部律师！" :filter-option="filterOption" />
                              </a-col>
                              <a-col :span="4" style="font-size:1.0rem; margin-top:5px; text-align: center;">
                                <span style="position:relative;" ><span style="color:red;margin-right:0px;position:absolute;left:-10px;top:0px;"></span>律师联系电话</span>
                              </a-col>
                              <a-col :span="8">
                                <a-input v-model="legal.revEmployeeMobile"  placeholder="请输入内部律师联系电话！" @blur="validFieldToast('revEmployeeMobile')" style="border: 0px solid #fefefe;  border-bottom: 1px solid #f0f0f0;" />
                              </a-col>
                            </a-row>
                          </div>   
                          </div> 

                          <div v-show=" '|再审阶段|执行阶段|归档闭单|'.includes(legal.stage) " class="reward-apply-content-item reward-apply-content-title" style="padding-top:5px;">
                            <a-row style="border-top: 1px dash #f0f0f0;" >
                              <a-col class="reward-apply-content-title-text" :span="4" style="font-size:1.1rem;">
                                诉讼信息
                              </a-col>
                        ...
                        <a-tab-pane v-if="(stage != 'evaluate' && role != 'process' && role != 'operate' && '|再审阶段|执行阶段|归档闭单|'.includes(legal.stage) ) || operate == 'execJudge'   " key="4" tab="执行管理" style="margin-left:0px;">
  ...
  data() {
    return {
      ...
      legal:{
        ...
        lastTime : dayjs().format('YYYY-MM-DD'), // timestamp default CURRENT_TIMESTAMP not null comment '最后修改时间',
        lastModifier : '', // varchar(32)  default '' not null comment '最后修改人员',
        legalStatus : '', // varchar(32)  default '' not null comment '案件状态 ',

        fstEvidence : null, // varchar(64)  default '' not null comment '一审举证期限',
        fstCourtDate : null, // varchar(32)  default '' not null comment '一审开庭时间',
        ...
        fstAppealTime : null, // varchar(32) default '' not null comment '一审上诉期',

        secEvidence : null, // varchar(64) default '' not null comment '二审举证期限',
        secCourtDate : null, // varchar(32) default '' not null comment '二审开庭时间',
        ...
        secAppealTime : null, // varchar(32)  default '' not null comment '二审上诉期',

        reviewEvidence : null, // varchar(64)  default '' not null comment '再审举证期限',
        reviewCourtDate: null, // varchar(32)  default '' not null comment '再审开庭时间',
        ...
        reviewAppealTime: null, // varchar(32)  default '' not null comment '再审上诉期',
